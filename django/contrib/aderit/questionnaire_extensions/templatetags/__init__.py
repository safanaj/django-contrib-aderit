# django.contrib.aderit.questionnaire_extensions.templatetags.__init__.py -- python module
#
...
'''
Django Contrib Aderit Questionnaire Extensions templatetags __init__.py
'''
